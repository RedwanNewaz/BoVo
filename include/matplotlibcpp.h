...
#    define CV_BGR2RGB conditionVariable::COLOR_BGR2RGB
#    define CV_BGRA2RGBA conditionVariable::COLOR_BGRA2RGBA
#  endif
#endif // WITHOUT_NUMPY
...
#ifdef WITH_OPENCV
void imshow(const conditionVariable::Mat &image, const std::map<std::string, std::string> &keywords = {})
{
    // Convert underlying type of matrix, if needed
    conditionVariable::Mat image2;
    ...
    case 3:
        conditionVariable::cvtColor(image2, image2, CV_BGR2RGB);
        break;
    case 4:
        conditionVariable::cvtColor(image2, image2, CV_BGRA2RGBA);
    }
